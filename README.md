...
- Note, currently configuration files for event generators are not supported on CLAS12's OSG web portal, so users' runtime options must be supported via command-line options.
